...
contract DonationTest is Test {
    ...
    function test_DonateEth() public {
        vm.startPrank(addr2);
            don.donateEth{value: 100e18}(addr2);
